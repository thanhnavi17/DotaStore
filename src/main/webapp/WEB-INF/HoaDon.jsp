                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div class="giaodich_ds">
                                            <div class="group_item">
                                                <table>
                                                    <tr>
                                                        <th style="width: 4%">Mã đơn hàng</th>
                                                        <th style="width: 10%">Ngày tạo</th>
                                                        <th style="width: 7%">Tổng tiền</th>
                                                        <th style="width: 5%">Trạng thái</th>
                                                    </tr>
                                                    <s:iterator value="lstHDBan" var="hd">
                                                    <tr>
                                                        <td>
                                                            <a href="hoaDonBanChiTiet?ma=${maHoaDon }"
                                                                style="color: #14a7ff; text-decoration: underline;">
                                                                <s:property value="maHoaDon"/>
                                                            </a>
                                                        </td>
